...
DEFAULT_LDFLAGS.32 = -L$(LIBDIR32) -Wl,-R$(LIBDIR32),--enable-new-dtags -L$(USRLIBDIR32) -Wl,-R$(USRLIBDIR32),--enable-new-dtags
DEFAULT_LDFLAGS.64 = -L$(LIBDIR64) -Wl,-R$(LIBDIR64),--enable-new-dtags -L$(USRLIBDIR64) -Wl,-R$(USRLIBDIR64),--enable-new-dtags

CONFIGURE_BINDIR.32 =	$(CONFIGURE_PREFIX)/bin/$(MACH32)
CONFIGURE_BINDIR.64 =	$(CONFIGURE_PREFIX)/bin
CONFIGURE_LIBDIR.32 =	$(CONFIGURE_PREFIX)/lib/$(MACH32)
...
CONFIGURE_ENV += LDFLAGS="$(DEFAULT_LDFLAGS.$(BITS)) $(LDFLAGS)"
...
CONFIGURE_OPTIONS += LDFLAGS="$(DEFAULT_LDFLAGS.$(BITS)) $(LDFLAGS)"
CONFIGURE_OPTIONS += PKG_CONFIG_PATH="$(PKG_CONFIG_PATH)"

CONFIGURE_OPTIONS.32 += --build=i386-unknown-linux-gnu
