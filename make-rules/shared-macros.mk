...
USRBINDIR64 =	$(USRDIR)/bin
USRSBINDIR =	$(USRDIR)/sbin
USRSBINDIR32 =	$(USRDIR)/sbin/$(MACH32)
USRSBINDIR64 =	$(USRDIR)/sbin
USRLIBDIR =	$(USRDIR)/lib/$(MACH32)
USRLIBDIR32 =	$(USRDIR)/lib/$(MACH32)
...
GNUBIN =	/usr/bin
GNULIB =	/usr/lib/$(MACH32)
GNULIB64 =	/usr/lib/$(MACH64)
GNUSHARE =	/usr/share
GNUSHAREMAN =	/usr/share/man
GNUSHAREMAN1 =	/usr/share/man/man1
...
# set MACH from uname -p 
MACH :=		$(shell uname -p)

MACH32 =	i386-linux-gnu

MACH64 =	x86_64-linux-gnu

MACH_BITS :=	$(shell getconf LONG_BIT)
DEFAULT_BUILD =		$(BUILD_$(MACH_BITS))
DEFAULT_INSTALL =	$(INSTALL_$(MACH_BITS))
DEFAULT_TEST =		$(TEST_$(MACH_BITS))
...
PERL_VERSIONS = 5.18 5.22

PERL.5.18 =	/usr/bin/perl
#PERL.5.22 =	/usr/perl5/5.22/bin/perl
PERL.5.22 =	/usr/bin/perl
...
PKG_CONFIG_PATH.32 = /usr/lib32/pkgconfig
PKG_CONFIG_PATH.64 = /usr/lib/pkgconfig
